					...
					<div class="row">
						...
						while($row=mysqli_fetch_assoc($result)){
								...
								while($row2=mysqli_fetch_assoc($result2)){
									...
									<img src="'.$str.'" style="width:100%;height: 55px;">
								</div>
								<div class="col-9 mb-5"><h5><a href="details.php?id='.$row2['product_id'].'">'.$row2['name'].'</a><br><span class="lead" style="font-size:15px;">Rs.'.$row2['price'].'</span></h5></div>';
								}
							
								echo'<div class="col-12"><p>Amount Paid-Rs.<b>'.$row['amount'].'</b></p></div>
								</div>
							</div>
						</div>';
						}
